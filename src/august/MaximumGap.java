...
public class MaximumGap {
    ...
    public int maximumGap(int[] nums) {
        ...
        int bucketSize =  (int)Math.ceil((double)(max-min)/(n -1)); // divided by n -> chances are every bucket will be filled.
        ...
        maxGap = Math.max(maxGap, max-min);// 2 // max will be the biggest element which we found initially.
        return maxGap;
    }
}
