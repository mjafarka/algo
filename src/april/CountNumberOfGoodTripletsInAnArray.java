...
/**
 * notes will be available in good notes. 
 * 
 * 
...
public class CountNumberOfGoodTripletsInAnArray {
    ...
    public long goodTriplets(int[] nums1, int[] nums2) {
        ...
        updateSegTree(1, 0, n - 1, nums2ValIdx.get(nums1[0])); // 1st element is inserted as common element before nums2idx. nums2idx = nums2ValIdx.get(nums1[0])
